...
output "logging_governance_assignment_id" {
  value       = azurerm_policy_assignment.logging_governance.id
  description = "The policy assignment id for logging_governance"
}

output "sentinel_governance_assignment_identity" {
  value       = azurerm_policy_assignment.logging_governance.identity
