...
resource AzSecBenchmarkAssign 'Microsoft.Authorization/policyAssignments@2021-06-01' = {
  ...
  properties: {
    displayName: 'Azure Security Benchmark  - Microsoft Reactor 2022 - Sub Scope'
    description: 'Applies Azure Security Benchmark policies at Subscription scope'
...
resource SecGovDemoAssign 'Microsoft.Authorization/policyAssignments@2021-06-01' = {
  ...
  properties: {
    displayName: 'Security Governance Demo - Microsoft Reactor 2022 - Sub Scope'
    description: 'Applies baseline security governance at Subscription scope'
    enforcementMode: 'Default'
...
resource SecGovDemoDef 'Microsoft.Authorization/policySetDefinitions@2020-09-01' = {
  ...
  properties: {
    ...
    policyDefinitions: [
      {
        policyDefinitionId: '/subscriptions/5bf747d8-aeef-42a9-9263-07379c144d5a/providers/Microsoft.Authorization/policyDefinitions/audit_roleAssignments'
      ...
      }
      {
        ...
        parameters: {
          ddosPlan: {
            value: '/subscriptions/5bf747d8-aeef-42a9-9263-07379c144d5a/resourceGroups/secgovdemoaus'
          }
        }
      }
      {
...
resource SecGovDemoRA1 'Microsoft.Authorization/roleAssignments@2020-04-01-preview' = {
  name: guid(SecGovDemoAssign.name, SecGovDemoAssign.type, subscription().subscriptionId)
  properties: {
